...
class Server:
    ...
    host : str, optional
        ...
        If starts with unix://, then it's treated as a unix sockets. If ends with a '/', then
        it's treated as a directory of unix sockets, with port being the file name.
    port : int, optional
    ...
    root_api_address: str, optional
        Root path of the reported api_adress, instead of http://{host}:{port}.
